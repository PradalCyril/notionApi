...
import { EmptyObject, ICollectible } from "./interfaces"
...
export const getItem: Function = async (addItem: Function): Promise<void> => {
  const responses: ICollectible = await fetch("https://my-nft-tracker-backend.azurewebsites.net/api/nfts/4d587ac2-2100-496f-9e44-28dd6b794432")
    .then((response): Promise<ICollectible | EmptyObject | unknown> => response.json())
    .then((data: any): ICollectible => ({
      name: data['name'],
